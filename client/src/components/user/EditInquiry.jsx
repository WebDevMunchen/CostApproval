...
export default function EditInquiry() {
  ...
  const [singleInquiry, setSingleInquiry] = useState(null);

  useEffect(() => {
    axiosClient
      .get(`/costApproval/${id}`)
      .then((response) => {
        setSingleInquiry(response.data);
                ...
                <form className="mt-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="w-full px-3 sm:w-1/2">
                      <div className="mb-5">
                        ...
                        <input
                          ...
                          defaultValue={singleInquiry.title}
                          type="text"
                          name="title"
                          id="title"
                  ...
                  <div className="mb-5">
                    ...
                    <textarea
                      ...
                      defaultValue={singleInquiry.additionalMessage}
                      ...
                      <div className="mb-5">
                        ...
                        <div className="flex gap-2">
                          <input
                            ...
                            defaultValue={singleInquiry.expenseAmount}
                            type="number"
                            name="expenseAmount"
                            id="expenseAmount"
                          ...
                          <input
                            {...register("expenseAmountCent", {
                              required: true,
                            })}
                            defaultValue={singleInquiry.expenseAmountCent}
                            type="number"
                    ...
                    <div className="w-full px-3 sm:w-1/2">
                      <div className="mb-5">
                        ...
                        <input
                          ...
                          defaultValue={
                            singleInquiry.deadline
                              ? singleInquiry.deadline.slice(0, 10)
                              : ""
                          }
                          type="date"
                          name="deadline"
