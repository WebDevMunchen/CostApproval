        ...
        <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          <div className="flex-1 mt-2 px-3 bg-white divide-y space-y-1">
            <ul className="space-y-2 pb-2">
              {/* <li>
                <NavLink className="text-base text-gray-900 font-semibold rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                  <svg
              ...
              <li>
                <NavLink to={"/meineAnfragen"} className="text-base text-gray-900 font-semibold rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
                    height="24"
              ...
              <li>
                <NavLink to={"/neueAnfrage"} className="text-base text-gray-900 font-semibold rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 576 512"
                    height="24"
              ...
              <li>
                <NavLink onClick={() => logout()} className="text-base text-gray-900 font-semibold rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    height="24"
